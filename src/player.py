...
class Sprite:
    ...
    def update(self, delta: float, surface):
        ...
        collision_data = self.get_collision_normal(surface, position_tilemap, self_rect)
    ...
    def get_collision_normal(self, surface, position_tilemap, self_rect: pygame.Rect) -> "CollisionData":
        ...
        for pos in position_around:
            ...
            if rect:
                collision_info = self.get_collision(rect, pygame.Vector2(self_rect.center))
    ...
    def get_collision(self, rect: pygame.Rect, center: pygame.Vector2) -> "CollisionData":
        ...
        if collision_normal.length() < self.radius and collision_normal.length() != 0:
            ...
            collision_info.update_normal(pygame.Vector2(center.x - collide_point_x, center.y - collide_point_y))
